...
class Telefon(ABC):
    def __init__(self, brend, model):
        self.brend = brend # public attributi
        self.model = model # public attributi
        self.__id = 0 # private attributi
        self._narxi = 0 # protected attributi
        self.tezkor_xotira_hajmi = 0 #public attributi
...
telefon1 = Samsung("Galaxy A03S")
telefon2 = iPhone("15 ProMax")

telefon1.narx_qoyish(1500)
telefon2.narx_qoyish(2000)

print(f"{telefon1.brendini_olish()} {telefon1.modelini_olish()} narxi: {telefon1.narxini_korish()}$")

print(f"{telefon2.brendini_olish()} {telefon2.modelini_olish()} narxi: {telefon2.narxini_korish()}$")
